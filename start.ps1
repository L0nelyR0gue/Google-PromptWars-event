...
Start-Process powershell -ArgumentList "-NoExit", "-Command", "Set-Location '$ProjectRoot'; python -m uvicorn main:app --host 0.0.0.0 --port 8000 --reload"
...
Write-Host "   Close the two new terminal windows to stop." -ForegroundColor Green
Write-Host "============================================" -ForegroundColor Green
Write-Host ""
